    ...
    return (
        <>
            ...
            <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
                    ...
                    <TextInput
                        style={styles.input}
                        value={tipoCombustivel_3}
                        onChangeText={(value) => setTipoCombustivel_3(value)}
                    />
                    ...
                    <TextInput
                        style={styles.input}
                        value={tipoCombustivel_4}
                        onChangeText={(value) => setTipoCombustivel_4(value)}
                    />
                    ...
                    <TextInput
                        style={styles.input}
                        value={tipoCombustivel_5}
                        onChangeText={(value) => setTipoCombustivel_5(value)}
                    />
                    ...
                    <TextInput
                        style={styles.input}
                        value={tipoCombustivel_6}
                        onChangeText={(value) => setTipoCombustivel_6(value)}
                    />           
